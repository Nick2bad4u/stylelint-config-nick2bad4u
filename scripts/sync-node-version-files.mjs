 ...
 * @returns {string}
 *
 * @throws {TypeError} If `version` is not a string or not an exact `x.y.z`
 *   value.
 */
 ...
 * }}
 *
 * @throws {TypeError} If an argument is unknown, missing, malformed, or
 *   incompatible.
 */
 ...
 * @returns {void}
 *
 * @throws {RangeError} If the preferred version is below `engines.node`.
 */
